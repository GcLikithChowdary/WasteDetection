const categories = {
  ...
  const higher_priority = ["Chemical Waste", "Medical Waste", "E-Waste", "Radioactive Waste","battery", "chemical", "paint", "oil", "solvent", "thermometer","bottle", "can", "paper", "cardboard", "glass", "metal", "plastic"];
  const medium_priority = ["Plastic", "Glass", "Paper", "Metals","phone", "laptop", "computer", "tv", "monitor", "printer","styrofoam", "ceramic", "light bulb", "cigarette", "diaper","cup"];
  const lower_priority = ["Household Trash", "Packaging Waste", "Street Litter","apple", "banana", "vegetable", "fruit", "leaves", "grass"];
  ...
  function classifyObject(objectName) {
    ...
    const nonRecyclableItems = ["styrofoam", "ceramic", "light bulb", "cigarette", "diaper","cup"];
